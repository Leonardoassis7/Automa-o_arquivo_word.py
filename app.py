...
pagina_fornecedores = planilha_fornecedores['Sheet1'] #  Esse sheet1 nome da pagina planilha
...
for linha in pagina_fornecedores.iter_rows(min_row=2,values_only=True):
    ...
    CONTRATANTE: Leonardo.ltda
    E-mail: Leonardo@leonardo.com
    ...
    arquivo_word.save(f'./contratos/contratos_{nome_empresa}.docx') #  Salvar na pasta de contrato, ja preenchido
